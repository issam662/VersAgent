...
async function test() {
    try {
        ...
        // Find the user
        const result = await pool.request().query("SELECT TOP 1 id, username, email_notifications FROM users WHERE username = 'Issam_IT'");
        ...
        console.log('After update:', result2.recordset[0]);
